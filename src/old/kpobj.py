...
def kolm_pollak_rule(model):
    return sum(populations_dict[r]*distances_transformed_dict[r,s]*model.y[r,s] for r, s in distances_transformed_dict)
  
model.kolm_pollak = pyo.Objective(rule=kolm_pollak_rule, sense=pyo.minimize)
...
if (result.solver.termination_condition == pyo.TerminationCondition.optimal):
    ...
    kp_value = pyo.value(model.kolm_pollak)
    ...
    output_path= 'kpobj'+str(num_to_open)+'.csv'
